...
if(SDL2_MIXER_IS_MSVC)
    ...
    message(STATUS "Main options ${SDL2_MIXER_CMAKE_ARGS}")
    message(STATUS "Additional options ${SDL2_MIXER_ADDITIONAL_CMAKE_ARGS}")
    execute_process(
        COMMAND ${CMAKE_COMMAND} ${SDL2_MIXER_CMAKE_ARGS} ${SDL2_MIXER_ADDITIONAL_CMAKE_ARGS} -S ${SDL2_MIXER_SOURCE_DIR} -B ${SDL2_MIXER_BUILD_DIR} 
