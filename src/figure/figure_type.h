...
enum e_figure_type {
    ...
    FIGURE_ENEMY_EGYPTIAN_SPEAR = 43, // default enemy soldier, barbarian
    FIGURE_ENEMY_EGYPTIAN_FAST_SPEAR = 44,
    ...
    FIGURE_ENEMY_EGYPTIAN_HEAVY_SPEAR = 51,
    ...
    // barbarians
    FIGURE_ENEMY_BARBARIAN_FAST_SPEAR = 113,
    FIGURE_ENEMY_BARBARIAN_FAST_SWORD = 114,
    FIGURE_ENEMY_BARBARIAN_CAMEL = 115,
    FIGURE_ENEMY_BARBARIAN_ELEPHANT = 116,
    FIGURE_ENEMY_BARBARIAN_CHARIOT = 117,
    FIGURE_ENEMY_BARBARIAN_SWORD = 118,
    FIGURE_ENEMY_BARBARIAN_HEAVY_SWORD = 119,
    FIGURE_ENEMY_BARBARIAN_HEAVY_SPEAR = 120,
    FIGURE_ENEMY_BARBARIAN_MOUNTED_ARCHER = 121,
    FIGURE_ENEMY_BARBARIAN_AXE = 122,
