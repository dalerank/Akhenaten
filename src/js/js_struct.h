...
#define ANK_SCRIPT_STRUCT_GET_MACRO(_1, _2, _3, _4, _5, _6, _7, _8, NAME,...) NAME
#define ANK_SCRIPT_STRUCT_PASTE(...) ANK_SCRIPT_STRUCT_EXPAND(ANK_SCRIPT_STRUCT_GET_MACRO(__VA_ARGS__, \
        ANK_SCRIPT_STRUCT_PASTE8, \
        ANK_SCRIPT_STRUCT_PASTE7, \
...
#define ANK_SCRIPT_STRUCT_PASTE8(func, v1, v2, v3, v4, v5, v6, v7) ANK_SCRIPT_STRUCT_PASTE2(func, v1) ANK_SCRIPT_STRUCT_PASTE7(func, v2, v3, v4, v5, v6, v7)
...
#define ANK_REGISTER_STRUCT_WRITER(Type, ...)                                                     \
namespace js_helper {                                                                             \
    template<>                                                                                    \
