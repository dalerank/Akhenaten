...
localization_ru = [
    ...
    { key: "#scriber_defenses_are_weak", "Даже самый простой враг смог бы пройти через нашу оборону!" }
    { key: "#scriber_need_more_workers", "Если вскоре не прибудет больше работников, город наверняка пострадает." }
    { key: "#scriber_gods_are_angry", "Литература изобилует историями о разгневанных богах и их мести." }
    { key: "#scriber_reputation_is_low", "История показывает, что такой город, как наш, заплатит серьёзные последствия за свою плохую репутацию." }
    { key: "#scriber_much_unemployments", "В городе много безработных. По крайней мере, у них много времени для чтения." }
    { key: "#scriber_low_entertainment", "Иногда мои глаза хотят отдохнуть на чём-то другом, кроме иероглифов. Я хочу увидеть шоу!" }
    { key: "#scriber_city_is_ok", "Этот город сравним с другими, о которых я читал." }
    { key: "#scriber_city_is_amazing", "Этот город - лучший, который когда-либо знала история!" }    
