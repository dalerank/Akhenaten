...
sidebar_window_expanded {
    ...
    ui {
        ...
        report_bug        : image_button({pos[114, 480 + 258], path:"pharaoh_general/interface_00086", tooltip:"Report bug", border:true, onclick: show_window_by_id("report_bug_window")})
    }
}
