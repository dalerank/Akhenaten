...
top_menu_widget = {
	...
	debug_render : {
	    buildings 		: menu_item({text:"xxx Buildings", parameter:1}),
	    tilesize 		: menu_item({text:"xxx Tile size", parameter:2}),
	    roads 			: menu_item({text:"xxx Roads", parameter:3}),
	    routing_dist 	: menu_item({text:"xxx Routing dist", parameter:4}),
	    routing_grid 	: menu_item({text:"xxx Routing grid", parameter:5}),
	    moisture 		: menu_item({text:"xxx Moisture", parameter:6}),
	    grass_level 	: menu_item({text:"xxx Grass level", parameter:7}),
	    grass_soil_depletion: menu_item({text:"xxx Soil depl", parameter:8}),
	    grass_flood_order	: menu_item({text:"xxx Flood order", parameter:9}),
	    grass_flood_flags	: menu_item({text:"xxx Flood flags", parameter:10}),
	    labor 			: menu_item({text:"xxx Labor", parameter:11}),
	    sprite_frames 	: menu_item({text:"xxx Sprite frames", parameter:12}),
	    terrain_bits 	: menu_item({text:"xxx Terrain bits", parameter:13}),
	    image 			: menu_item({text:"xxx Image", parameter:14}),
	    image_alt 		: menu_item({text:"xxx Image alt", parameter:15}),
	    marshland 		: menu_item({text:"xxx Marshland", parameter:16}),
	    terrain_type 	: menu_item({text:"xxx Terrain", parameter:17}),
	    tile_pos 		: menu_item({text:"xxx Tile coord", parameter:20}),
	    floodplain_shore: menu_item({text:"xxx Flood shore", parameter:21}),
	    tile_toph 		: menu_item({text:"xxx Tile toph ", parameter:22}),
	    ...
	    entertainment  	: menu_item({text:"xxx Entertainment", parameter:30}),
	    canals       	: menu_item({text:"xxx Canals", parameter:31}),
	    overlay_add    	: menu_item({text:"xxx Overlay add", parameter:32}),
	    gardens      	: menu_item({text:"xxx Gardens", parameter:33}),
	    routing_noncitizen : menu_item({text:"xxx Routing noncitizen", parameter:34}),
	    routing_amphibia: menu_item({text:"xxx Routing amphibia", parameter:35}),
	    routing_water   : menu_item({text:"xxx Routing water", parameter:36}),
	},
