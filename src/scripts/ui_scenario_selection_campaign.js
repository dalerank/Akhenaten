...
window_scenario_selection_campaign {
    ...
    ui {
        ...
        camp_0 : large_button({ pos[210, 261 + 120], size[144, 25], text[294, 0], font:FONT_NORMAL_BLACK_ON_LIGHT, onclick: show_scenario_company(0), onhover: campaign_period_hover(0), onunhover: campaign_period_unhover })
        camp_1 : large_button({ pos[210, 291 + 120], size[144, 25], text[294, 4], font:FONT_NORMAL_BLACK_ON_LIGHT, onclick: show_scenario_company(1), onhover: campaign_period_hover(1), onunhover: campaign_period_unhover })
        camp_2 : large_button({ pos[210, 321 + 120], size[144, 25], text[294, 8], font:FONT_NORMAL_BLACK_ON_LIGHT, onclick: show_scenario_company(2), onhover: campaign_period_hover(2), onunhover: campaign_period_unhover })
        camp_3 : large_button({ pos[210, 351 + 120], size[144, 25], text[294, 12], font:FONT_NORMAL_BLACK_ON_LIGHT, onclick: show_scenario_company(3), onhover: campaign_period_hover(3), onunhover: campaign_period_unhover })
        camp_4 : large_button({ pos[210, 381 + 120], size[144, 25], text[294, 16], font:FONT_NORMAL_BLACK_ON_LIGHT, onclick: show_scenario_company(4), onhover: campaign_period_hover(4), onunhover: campaign_period_unhover })
        camp_5 : large_button({ pos[362, 261 + 120], size[144, 25], text[294, 20], font:FONT_NORMAL_BLACK_ON_LIGHT, onclick: show_scenario_company(5), onhover: campaign_period_hover(5), onunhover: campaign_period_unhover })
        camp_6 : large_button({ pos[362, 291 + 120], size[144, 25], text[294, 24], font:FONT_NORMAL_BLACK_ON_LIGHT, onclick: show_scenario_company(6), onhover: campaign_period_hover(6), onunhover: campaign_period_unhover })
        camp_7 : large_button({ pos[362, 321 + 120], size[144, 25], text[294, 28], font:FONT_NORMAL_BLACK_ON_LIGHT, onclick: show_scenario_company(7), onhover: campaign_period_hover(7), onunhover: campaign_period_unhover })
        camp_8 : large_button({ pos[362, 351 + 120], size[144, 25], text[294, 32], font:FONT_NORMAL_BLACK_ON_LIGHT, onclick: show_scenario_company(8), onhover: campaign_period_hover(8), onunhover: campaign_period_unhover })
    }
}
