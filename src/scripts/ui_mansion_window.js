...
info_window_mansion {
    ...
    ui {
        ...
        change_salary : button({textfn:change_salary_button_text, onclick:show_window_by_id("set_salary_window"), margin{centerx:-200, top:70}, size[400, 30], font: FONT_NORMAL_BLACK_ON_DARK }),
