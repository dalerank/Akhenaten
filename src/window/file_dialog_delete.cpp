...
struct file_dialog_delete : public autoconfig_window_t<file_dialog_delete> {
...
file_dialog_delete g_file_dialog_delete;
...
static void draw_foreground(int) {
    ...
    if (data.message_not_exist_start_time
        ...
        ui::label(43, 6, vec2i{160, 50}, FONT_LARGE_BLACK_ON_LIGHT, UiFlags_AlignCentered, 304);
    }
...
static void button_double_click(int param1, int param2) {
    // DELETE dialog doesn't allow double-click to confirm
}
