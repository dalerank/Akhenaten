...
static hotkey_widget hotkey_widgets[] = {
  ...
  {HOTKEY_COPY_BUILD, "#TR_HOTKEY_COPY_BUILD"},
  {HOTKEY_BUILD_CLEAR_LAND, "", 68, 21},
  {HOTKEY_BUILD_VACANT_HOUSE, "", 67, 7},
  {HOTKEY_BUILD_ROAD, "", GROUP_BUILDINGS, BUILDING_ROAD},
  {HOTKEY_BUILD_PLAZA, "", GROUP_BUILDINGS, BUILDING_PLAZA},
  {HOTKEY_BUILD_GARDENS, "", GROUP_BUILDINGS, BUILDING_GARDENS},
  {HOTKEY_BUILD_FIREHOUSE, "", GROUP_BUILDINGS, BUILDING_FIREHOUSE},
  {HOTKEY_BUILD_ARCHITECT, "", GROUP_BUILDINGS, BUILDING_ARCHITECT_POST},
  {HOTKEY_BUILD_APOTHECARY, "", GROUP_BUILDINGS, BUILDING_APOTHECARY},
  {HOTKEY_BUILD_GRANARY, "", GROUP_BUILDINGS, BUILDING_GRANARY},
  {HOTKEY_BUILD_STORAGE_YARD, "", GROUP_BUILDINGS, BUILDING_STORAGE_YARD},
  {HOTKEY_BUILD_BAZAAR, "", GROUP_BUILDINGS, BUILDING_BAZAAR},
  {HOTKEY_BUILD_WALL, "", GROUP_BUILDINGS, BUILDING_MUD_WALL},
  {HOTKEY_BUILD_GATEHOUSE, "", GROUP_BUILDINGS, BUILDING_MUD_GATEHOUSE},
  {HOTKEY_BUILD_WATERLIFT, "", GROUP_BUILDINGS, BUILDING_WATER_LIFT},
  {HOTKEY_BUILD_CANAL, "", GROUP_BUILDINGS, BUILDING_IRRIGATION_DITCH},
  {HOTKEY_BUILD_WATER_SUPPLY, "", GROUP_BUILDINGS, BUILDING_WATER_SUPPLY},
  {HOTKEY_BUILD_ROADBLOCK, "", GROUP_BUILDINGS, BUILDING_ROADBLOCK},
...
static pcstr bottom_button_texts[] = {"#TR_BUTTON_RESET_DEFAULTS", "#TR_BUTTON_CANCEL", "#TR_BUTTON_OK"};
