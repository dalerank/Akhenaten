...
void js_register_empire_object_proto(js_State* J) {
    ...
    J->newcconstructor(jsB_new_EmpireObject, jsB_new_EmpireObject, js_intern("EmpireObject"), 1);
...
void js_register_empire_city_map_proto(js_State* J) {
    ...
    J->newcconstructor(jsB_new_EmpireCityObject, jsB_new_EmpireCityObject, js_intern("EmpireCityObject"), 1);
...
void js_register_empire_city_proto(js_State* J) {
    ...
    J->newcconstructor(jsB_new_EmpireCity, jsB_new_EmpireCity, js_intern("EmpireCity"), 1);
...
static void proto_def_readonly(js_State* J, js_CFunction get, const char* name) {
    ...
    J->newcfunction(proto_set_readonly, js_intern(""), 1);
...
void js_register_empire_trader_proto(js_State* J) {
    ...
    J->newcconstructor(jsB_new_EmpireTrader, jsB_new_EmpireTrader, js_intern("EmpireTrader"), 1);
...
void js_register_invasion_warning_proto(js_State* J) {
    ...
    J->newcconstructor(jsB_new_InvasionWarning, jsB_new_InvasionWarning, js_intern("InvasionWarning"), 1);
