...
enum e_building_type : uint16_t {
	...
	BUILDING_MEADOW_BARLEY_FARM = 311,
	BUILDING_MEADOW_FLAX_FARM = 312,
	BUILDING_MEADOW_GRAIN_FARM = 313,
	BUILDING_MEADOW_LETTUCE_FARM = 314,
	BUILDING_MEADOW_POMEGRANATES_FARM = 315,
	BUILDING_MEADOW_CHICKPEAS_FARM = 316,
