...
| `188_music_track_advance.js` | #634: city tracks play once; `music_next_track` picks a different track, follows music.txt main/alternate order per mission, keeps the track across population changes, stops when music is disabled |
