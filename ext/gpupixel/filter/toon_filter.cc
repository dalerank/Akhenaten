...
bool ToonFilter::proceed(bool updateSinks, int64_t frametime) {
  _filterProgram->setUniformValue("threshold", threshold_);
  _filterProgram->setUniformValue("quantizationLevels", quantization_levels_);
